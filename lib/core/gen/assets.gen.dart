...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/search_icon_lightmode.svg
  SvgGenImage get searchIconLightmode =>
      const SvgGenImage('assets/icons/search_icon_lightmode.svg');

  /// List of all assets
  List<SvgGenImage> get values => [searchIconLightmode];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/news_logo_darkmode.png
  AssetGenImage get newsLogoDarkmode =>
      const AssetGenImage('assets/images/news_logo_darkmode.png');

  /// File path: assets/images/news_logo_lightmode.png
  AssetGenImage get newsLogoLightmode =>
      const AssetGenImage('assets/images/news_logo_lightmode.png');
  ...
  /// File path: assets/images/splash_darkmode.png
  AssetGenImage get splashDarkmode =>
      const AssetGenImage('assets/images/splash_darkmode.png');

  /// File path: assets/images/splash_lightmode.png
  AssetGenImage get splashLightmode =>
      const AssetGenImage('assets/images/splash_lightmode.png');
